# 📓 개발일지 및 기술 아키텍처 참고서 (Naver Blog AI Studio DevLog)
...
## 🌟 핵심 기능 및 주요 업데이트 (v2.0 ~ v2.1)

### 1. 실시간 검색 트렌드 & 카테고리별 스마트 셔플
- **동적 연도(2026년) 및 카테고리 탭**: 전체, 재테크·부업, IT·AI, 여행·맛집, 건강·다이어트, 부동산·절세 등 50여 개 이상의 고단가 키워드 풀 탑재.
- **접속 시 자동 랜덤 셔플**: 접속할 때마다 `pickRandomTopics()`로 새로운 주제 4선 추출.
- **AI 실시간 트렌드 생성**: `[AI 실시간 트렌드 뽑기]` 버튼으로 네이버 급상승 키워드를 Gemini가 실시간 도출.
...
### 7. 웹앱 하단 블덱스(Blogdex) 블로그 지수 분석기 링크 제공
...
│   │   │   ├── Step1Research.jsx # 트렌드 키워드 & 기획 브리핑
